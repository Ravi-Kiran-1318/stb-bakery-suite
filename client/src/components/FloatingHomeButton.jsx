  ...
  return (
    <AnimatePresence>
      ...
      >
        <Link
          to="/"
          className="flex items-center justify-center w-14 h-14 bg-gradient-to-r from-[#D4AF37] to-[#EFDBB2] text-[#332200] rounded-full shadow-[0_0_15px_rgba(212,175,55,0.4)] hover:shadow-[0_0_25px_rgba(212,175,55,0.6)] transition-all hover:-translate-y-1 group"
