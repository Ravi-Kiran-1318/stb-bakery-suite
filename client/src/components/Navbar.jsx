          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="relative group flex items-center z-50">
              <button className="p-2 rounded-full transition-colors hover:bg-gray-100 text-gray-800 flex items-center gap-1 cursor-pointer">
                {/* Mobile Text Indicator (hidden on sm+) */}
                <span className="sm:hidden flex items-center justify-center w-[22px] h-[22px] rounded-full border-2 border-gray-300 text-[11px] font-bold text-gray-700 bg-white shadow-sm">
                  {language === 'en' ? 'EN' : 'తె'}
                </span>
                
                {/* Desktop Globe Icon (hidden on mobile) */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hidden sm:block w-5 h-5">
