...
const WhatsAppButton = ({ label, message, variant = 'filled', className = '' }) => {
  ...
  const variants = {
    filled: "bg-[#25D366] hover:bg-[#128C7E] text-white px-4 py-2",
    outlined: "border border-[#25D366] text-[#25D366] hover:bg-green-50 px-4 py-2",
    icon: "text-[#25D366] hover:text-[#128C7E] p-2"
  };
